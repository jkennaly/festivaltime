...
(function (Z, Q, r) {
    ...
    function F(b) {
        return function () {
            var a = arguments[0], c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.2.7/" + (b ? b + "/" : "") + a;
    ...
    function Zb(b) {
        ...
        var f = {}, h = "Provider", m = [], k = new Ra, l = {$provide: {provider: a(c), factory: a(d), service: a(function (a, b) {
            ...
            "$exceptionHandler", "$http", "$templateCache", "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, l, n, p, s, C, y, E, u, R, H) {
                ...
                function ia(a, c, d, e, g, f, m, n, p) {
                    ...
                    function E(a, e, g, f, p) {
                        ...
                        gb = p && y;
                        V && q(V, function (a) {
                            var b = {$scope: a === H || a.$$isolateScope ? J : e, $element: v, $attrs: I, $transclude: gb}, c;
                            P = a.controller;
                            "@" == P && (P =
                                I[a.name]);
                            c = C(P, b);
                ...
                function T(b, e, g, f, k, s, n) {
                    ...
                    if (c.hasOwnProperty(e)) {
                        ...
                        for (var C = 0, y = e.length; C < y; C++)try {
                            p = e[C], (f === r || f > p.priority) && -1 != p.restrict.indexOf(g) && (s && (p = Rb(p, {$$start: s, $$end: n})), b.push(p), k = p)
                        } catch (v) {
                            l(v)
                        }
                    }
                ...
                function w(a, b, c, d, e, g, f, m) {
                    var k = [], l, s, C = b[0], y = a.shift(), v = t({}, y, {templateUrl: null, transclude: null, replace: null, $$originalDirective: y}), R = L(y.templateUrl) ? y.templateUrl(b, c) : y.templateUrl;
                    b.empty();
    ...
    function Fd() {
        this.$get = ["$window", "$document", function (b, a) {
            ...
            return{history: !(!b.history || !b.history.pushState || 4 > d || e), hashchange: "onhashchange"in b && (!f || 7 < f), hasEvent: function (a) {
                ...
                return c[a]
            }, csp: Tb(), vendorPrefix: h, transitions: l, animations: n, android: d, msie: M, msieDocumentMode: f}
        }]
    }
    ...
    }, M, A, Ba, va = [].slice, Qd = [].push, Za = Object.prototype.toString, La = F("ng"), Na = Z.angular || (Z.angular = {}), Ta, Fa, ka = ["0", "0", "0"];
    ...
    var Tc = /[A-Z]/g, Rd = {full: "1.2.7", major: 1, minor: 2, dot: 7, codeName: "emoji-clairvoyance"}, Qa = O.cache = {}, db = O.expando = "ng-" + (new Date).getTime(),
        ...
        }, Vc = /([\:\-\_]+(.))/g, Wc = /^moz([A-Z])/, xb = F("jqLite"), Ea = O.prototype = {ready: function (b) {
            function a() {
                c || (c = !0, b())
            }
    ...
    var hd = /^(x[\:\-_]|data[\:\-_])/i, oc = F("$interpolate"), Ud = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, sd = {http: 80, https: 443, ftp: 21}, Hb = F("$location");
    tc.prototype = Ib.prototype = sc.prototype = {$$html5: !1, $$replace: !1, absUrl: ib("$$absUrl"), url: function (a, c) {
    ...
    var ya = F("$parse"), xc = {}, ra, Ia = {"null": function () {
        return null
    }, "true": function () {
        return!0
    }, "false": function () {
    ...
    var Jb = {}, sa = F("$sce"), ea = {HTML: "html", CSS: "css", URL: "url", RESOURCE_URL: "resourceUrl", JS: "js"}, Y = Q.createElement("a"), zc = qa(Z.location.href, !0);
    Ac.$inject = ["$provide"];
    Bc.$inject = ["$locale"];
    Dc.$inject = ["$locale"];
    var Gc = ".", Pd = {yyyy: W("FullYear", 4),
        yy: W("FullYear", 2, 0, !0), y: W("FullYear", 1), MMMM: kb("Month"), MMM: kb("Month", !0), MM: W("Month", 2, 1), M: W("Month", 1, 1), dd: W("Date", 2), d: W("Date", 1), HH: W("Hours", 2), H: W("Hours", 1), hh: W("Hours", 2, -12), h: W("Hours", 1, -12), mm: W("Minutes", 2), m: W("Minutes", 1), ss: W("Seconds", 2), s: W("Seconds", 1), sss: W("Milliseconds", 3), EEEE: kb("Day"), EEE: kb("Day", !0), a: function (a, c) {
    ...
    var Ld = $(x), Md = $(Ga);
    Ec.$inject = ["$parse"];
    var Wd = $({restrict: "E", compile: function (a, c) {
    ...
    var Jc = function (a) {
        ...
        }, Xd = Jc(), Yd = Jc(!0), Zd = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/, $d = /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,6}$/, ae =
            /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Kc = {text: pb, number: function (a, c, d, e, g, f) {
            pb(a, c, d, e, g, f);
        ...
        }, de = $({require: "ngModel", link: function (a, c, d, e) {
        ...
        }], ke = Mb("", !0), le = Mb("Odd", 0), me = Mb("Even", 1), ne = ta({compile: function (a, c) {
            c.$set("ngCloak", r);
    ...
    var pe = ["$animate", function (a) {
    ...
    }], se = ta({priority: 450, compile: function () {
        ...
        return{transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, link: function (e, g, f, h, m) {
            var k = f.ngRepeat, l = k.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/), n, p, s, r, y, t, u = {$id: Da};
            if (!l)throw d("iexp", k);
            f = l[1];
            h = l[2];
        ...
        return{restrict: "EA", require: "ngSwitch", controller: ["$scope",
            function () {
                this.cases = {}
    ...
    }], Ae = ta({transclude: "element", priority: 800, require: "^ngSwitch", compile: function (a, c) {
    ...
    }}), Ce = ta({controller: ["$element", "$transclude", function (a, c) {
        ...
        return{restrict: "E", require: ["select", "?ngModel"], controller: ["$element", "$scope", "$attrs", function (a, c, d) {
            ...
            function n(e, f, g) {
                function h() {
                    ...
                    for (C = c.length; I < C; I++) {
                        ...
                        for (F = k.length; z < F; z++)r = k[z], (d = v[z + 1]) ? (E = d.element, d.label !== r.label &&
                            E.text(d.label = r.label), d.id !== r.id && E.val(d.id = r.id), E[0].selected !== r.selected && E.prop("selected", d.selected = r.selected)) : ("" === r.id && y ? H = y : (H = u.clone()).val(r.id).attr("selected", r.selected).text(r.label), v.push({element: H, label: r.label, id: r.id, selected: r.selected}), E ? E.after(H) : t.element.append(H), E = H);
                ...
                var m = c(k[2] || k[1]), l = k[4] || k[6], n = k[5], p = c(k[3] || ""),
                    q = c(k[2] ? k[1] : l), A = c(k[7]), w = k[8] ? c(k[8]) : null, x = [
                        [
                            {element: f, label: ""}
                        ]
                    ];
    ...
    (Ba = Z.jQuery) ? (A = Ba, t(Ba.fn, {scope: Ea.scope,
        isolateScope: Ea.isolateScope, controller: Ea.controller, injector: Ea.injector, inheritedData: Ea.inheritedData}), wb("remove", !0, !0, !1), wb("empty", !1, !1, !1), wb("html", !1, !1, !0)) : A = O;
    Na.element = A;
    (function (a) {
        t(a, {bootstrap: Yb, copy: fa, extend: t, equals: ua, element: A, forEach: q, injector: Zb, noop: w, bind: bb, toJson: pa, fromJson: Ub, identity: Aa, isUndefined: z, isDefined: B, isString: D, isFunction: L, isObject: X, isNumber: rb, isElement: Pc, isArray: K, version: Rd, isDate: Ja, lowercase: x, uppercase: Ga, callbacks: {counter: 0}, $$minErr: F,
            $$csp: Tb});
        Ta = Uc(Z);
        try {
            Ta("ngLocale")
        ...
        Ta("ng", ["ngLocale"], ["$provide", function (a) {
            ...
            a.provider("$compile", ic).directive({a: Wd, input: Lc, textarea: Lc, form: Xd, script: De, select: Ge, style: Ie, option: He, ngBind: he, ngBindHtml: je, ngBindTemplate: ie, ngClass: ke, ngClassEven: me, ngClassOdd: le, ngCloak: ne, ngController: oe, ngForm: Yd, ngHide: xe, ngIf: pe, ngInclude: qe, ngInit: se, ngNonBindable: te, ngPluralize: ue, ngRepeat: ve, ngShow: we, ngStyle: ye, ngSwitch: ze,
                ngSwitchWhen: Ae, ngSwitchDefault: Be, ngOptions: Fe, ngTransclude: Ce, ngModel: ce, ngList: ee, ngChange: de, required: Mc, ngRequired: Mc, ngValue: ge}).directive({ngInclude: re}).directive(Nb).directive(Nc);
            a.provider({$anchorScroll: cd, $animate: Td, $browser: ed, $cacheFactory: fd, $controller: id, $document: jd, $exceptionHandler: kd, $filter: Ac, $interpolate: pd, $interval: qd, $http: ld, $httpBackend: nd, $location: td, $log: ud, $parse: xd, $rootScope: Ad, $q: yd, $sce: Ed, $sceDelegate: Dd, $sniffer: Fd, $templateCache: gd, $timeout: Gd, $window: Hd})
        }])
    })(Na);
    A(Q).ready(function () {
        Sc(Q, Yb)
