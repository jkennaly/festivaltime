        ...
        <div id="bandgallery">
            ...
            If (mysql_num_rows($result) > 0) {
                while ($row = mysql_fetch_array($result)) {
                    ...
                    ?>
                    <table class="bandcap">
                        <caption align="bottom"><?php echo $rmvbutton; ?></caption>
                        <tr>
                            <td class=\"pic_cell\">
                                <img class="gallery_pic"
                                     src="includes/content/blocks/getSpecPic.php?picid=<?php echo $row['id']; ?>&fest=<?php echo $_SESSION['fest']; ?>"
                                     alt="gallery pic"/>
                        </tr>
                    </table>
                <?php
