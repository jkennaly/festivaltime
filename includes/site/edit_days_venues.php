...
<input size="30" type="text" name="name[<?php echo $i; ?>]" value="<?php echo $dd['name']; ?>"><br />
	Offset Days
<img alt="info_icon" src="includes/images/emblem-notice.png" title="The offset days is the number of days after the date basedate that this day. E.g., for a Fri-SAT fest, offseet is 0 Fri, 1 Sat, 2 Sun" />:
<input type="number" name="days_offset[<?php echo $i; ?>]" min="0" max="30" value="<?php echo $dd['days_offset']; ?>"><br />
</div> <!-- end .festeditday -->
