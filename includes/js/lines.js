...
connect(divband34, divband-1, 100, 53.33, "#0F0", 5);
connect(divband-1, divband-1, 53.33, 55.56, "#0F0", 5);
connect(divband-1, divband124, 55.56, 0, "#0F0", 5);
...
connect(divband10, divband-1, 61.9, 85.56, "#0F0", 5);
connect(divband-1, divband-1, 85.56, 87.78, "#0F0", 5);
connect(divband-1, divband101, 87.78, 0, "#0F0", 5);
