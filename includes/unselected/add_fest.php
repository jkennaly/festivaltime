...
<div id="content">
    ...
    <p>Festival Start Time (make sure this includes the start of the show. Earlier is fine, but it cannot be later than
        the first band.)
        <input type="time" name="start"/></p>

    <p>Festival Length (The number of hours between the start time and when the last band walks off stage. Longer is
        OK.)
    ...
    <input type="submit" value="Create Show" name="newfest"/>
    </form>
    <?php
    } else {
