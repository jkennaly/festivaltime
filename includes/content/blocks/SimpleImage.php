...
class SimpleImage
{
    ...
    function crop($x1, $y1, $x2, $y2)
    {
        ...
        $crop_height = $y2 - $y1;
        /*
        error_log(print_r("x1: ".$x1, TRUE));
        error_log(print_r("x2: ".$x2, TRUE));
        error_log(print_r("y1: ".$y1, TRUE));
        error_log(print_r("y2: ".$y2, TRUE));
        error_log(print_r("w: ".$crop_width, TRUE));
        error_log(print_r("h: ".$crop_height, TRUE));
        */
        // Perform crop
