...
If(mysql_num_rows($res)>0) {
	...
	echo"<h3><a id=\"displayText\" title=\"Click to toggle discussion\" href=\"#\" onclick=\"toggle(toggleText, displayText);return false;\">".$row['comment']."</h3><div id=\"toggleText\" style=\"display: none\">";
