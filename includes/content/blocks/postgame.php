...
$intMaster = getMasterBandIDFromFest($chosen, $main);
...
//echo "<br>intMaster: $intMaster shapecode: $shapeCode x: $x y: $y";
$bandOK = doesBandHaveShape($intMaster, $master, $shapeCode);

if($bandOK){
	$bandPicResult = getBandPicAndShape($intMaster, $master, $shapeCode);
