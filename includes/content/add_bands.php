...
//Get data to make the pick lists
        ...
        <p>
            ...
            This page allows for adding bands to the festival. You can either select a band from the list of bands
            already entered, or enter a new band.
        ...
        <form action="index.php?disp=add_bands" method="post">
            ...
            If ($right_required == "AddBands") {
                ?>
                <input type="text" name="new_band"/>
            <?php
            }
            ?>
            <input type="submit" value="Add to festival"/>
        </form>
    <?php
