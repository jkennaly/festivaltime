...
$post_target = $basepage."?disp=search_dev";

?>
<div id="searchbox">
<form action="<?php echo $post_target; ?>" method="post">
<input type="text" size="64" name="search_query"></textarea>
<br>
...
<input type="checkbox" checked="checked" name="discussions" value="true">Discussions</input>
<br>
...
//Update the tracking columns in the comment table to reflect the activity
	If(!empty($_POST['bands'])) {
		...
		If(mysql_num_rows($result) > 0 ) {
			...
			include $baselocation."includes/content/blocks/display_bands.php";
