...
<?php
	...
	$query="SELECT Users.username AS username, Users.username AS name, rating, comment FROM ratings, comments, Users WHERE ratings.band='$band' AND comments.band='$band' AND ratings.user=comments.user AND ratings.user=Users.id AND Users.username='".$_SESSION['user']."'";
