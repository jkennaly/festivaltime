...
//	echo "Band will start in ".$time_to_start_min." min.<br>";
        ...
        If ($time_to_start_min < $max_min && $time_remaining_percent > 50) {
            $scoring_factor = 1;
        } else {
...
<?php
    ...
    <h1 class="error">This festival is not currently running. You can change to a SimFest at the main site to experiment
        with Gametime when a fest is not running.</h1>
    <p>
