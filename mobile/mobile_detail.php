...
//echo $sql_raters."<br>";
                    ...
                    If (mysql_num_rows($res_raters) > 0) {
                        ...
                        echo "<dd class=\"friends" . $rate_row['rating'] . "\">" . getUname($v['fromuser']) . "(at the show):";
                        If (!empty($rate_row['rating'])) echo "" . $rate_row['rating'] . "/";
                        If (!empty($rate_row['comment'])) echo "" . $rate_row['comment'] . "";
                        echo "</dd>";
                    } else echo "<dd>" . getUname($v['fromuser']) . "(at the show)</dd>";
...
//		echo $sql_raters;
                    ...
                    If (mysql_num_rows($res_raters) > 0) {
                        $rate_row = mysql_fetch_array($res_raters);
                        echo "<dd class=\"friends" . $rate_row['rating'] . "\">" . getUname($v['fromuser']) . "(left the show):";
                        If (!empty($rate_row['rating'])) echo "" . $rate_row['rating'] . "/";
                        If (!empty($rate_row['comment'])) echo "" . $rate_row['comment'] . "";
                        echo "</dd>";
                    } else echo "<dd>" . getUname($v['fromuser']) . "(left the show)</dd>";
                } //Closes If($v['status'] == "present")
            }
